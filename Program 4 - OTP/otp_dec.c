...
* otp_dec_d server to encrypt the textfiles
...
* has decrypted the textfile, it will send the
* decrypted data back here where it will be
* displayed or outputted to a new file.
****syntax: otp_dec plaintext key port****
*********************************************/
...
void main(int argc, char *argv[])
{
	...
	else
	{
		...
		fprintf(stderr, "otp_dec cannot use otp_enc_d. The connection was rejected");
